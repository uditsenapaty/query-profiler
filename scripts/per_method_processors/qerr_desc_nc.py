# =========================================================
# scripts/per_method_processors/qerr_desc_nc.py
#
# Same as qerr_desc.py but removes all rows whose own
# count_rows OR neighbor_count_rows is 0. Saves qerr_desc_nc.csv
# inside qerr_sorted.
# =========================================================
...
def run(results_dir):
    ...
    # =====================================
    # Remove rows whose own count_rows OR
    # neighbor_count_rows is 0
    # =====================================

    merged = merged[
        (merged["count_rows"] != 0)
        &
        (merged["neighbor_count_rows"] != 0)
    ]
    ...
    out_csv = (OUTPUT_DIR / "qerr_desc_nc.csv")
    ...
    out_path = (
        OUTPUT_DIR /
        "qerror_vs_planchange_cdf_GLOBAL_nc.png"
    )
