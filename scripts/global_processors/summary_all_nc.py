    ...
    for gt_root in candidates:
        ...
        for query_dir in sorted(gt_root.iterdir()):
            ...
            for method_dir in sorted(query_dir.iterdir()):
                ...
                summary_path = method_dir / "summary_nc.csv"
...
def run(base_path: Path):
    ...
    for (gt_root, res, run_type, method) in sorted(
        ...
        out_dir = gt_root / "summaries_nc" # queries_dir_name
        ...
        # -----------------------------------------
        out_name = f"summary_all_{method}_{run_type}_nc.csv"
        ...
        print(
            ...
            f"{gt_root.name}/summaries_nc/{out_name}" # {queries_dir_name}/{out_name}"
        )
